...
local guides — Julien (Paris), Willem (Bruges), Daan (Amsterdam) — narrating
...
- Views: **Guide** (his letter + everything worth seeing), **Near me**
  (sorted by distance from you), **Map** (offline street maps, pins, blue dot).
